...
async function VideoData({ children }) {
  ...
  return <VideoGrid data={data}>{children}</VideoGrid>;
}
  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ width: "100%", height: "400px", background: "#fb42b2", paddingBottom: "2rem", marginBottom: "0" }}>
        ...
        >
          <a href="/" style={{ fontWeight: "bold", fontSize: "1.25rem", textDecoration: "none", color: "#fff", marginLeft: "1rem" }}>
            Home
          </a>
        </nav>
      ...
      <main className={styles.main}>
        <p className={styles.description}>Enjoy a curated selection of Nicolas Cage facts and videos. Click any card to watch!</p>
