...
export default function CourseBig({ dataPromise }: { dataPromise: Promise<Course[]> }) {
        ...
        >
          <div className={`group w-4/5 h-[300px] rounded-xl mx-auto mb-8 flex flex-row justify-left cursor-pointer`}>
            ...
            <div className="relative w-full overflow-hidden border-2 rounded-xl border-white h-[270px] mt-3">
              <div
                className={`absolute inset-0 origin-left scale-x-0 transition-transform duration-500 ease-in-out group-hover:scale-x-100 ${getBgClass(course.dicipline)}`}
              />
