<template>
  <div>
    <h3 class="text-4xl font-semibold">{{ albumName }}</h3>
    <div class="flex w-full mt-10 items-center justify-center bg-grey-lighter">
      <form enctype="multipart/form-data" novalidate>
        <label
          class="w-64 flex flex-col items-center px-4 py-6 bg-white text-indigo rounded-lg shadow-lg tracking-wide uppercase border border-indigo cursor-pointer hover:bg-indigo hover:text-indigo-600"
        >
          <svg
            class="w-8 h-8"
            fill="currentColor"
