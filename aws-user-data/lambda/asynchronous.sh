# LINUX / MAC
aws lambda invoke --function-name DemoLambdaFunction --cli-binary-format raw-in-base64-out --payload '{"key1": "value1", "key2": "value2", "key3": "value3" }' --invocation-type Event --region response.json
